...
<?php // include('configs/init.php'); ?>
   ...
   // if(isset($_GET['teacher_id'])){
    ...
    <td>
        <input class="form-controll" style="width: 120px;" type="date" onchange="change()" name="" id="dates"
            placeholder="بەرواری هاتن">
        
        </td>
    <td>
        <input class="form-controll" style="width: 100px;" type="text" name="" value="" id="day_name"
            placeholder="ڕۆژی هاتن"> 
        </td>
    <td>
        <input class="form-controll" style="width: 50px;" title="ژ.هەفتە" type="text" name="" id="num_week"
            >
        </td>
    <td>
        <?php 
