...
<?php
   endforeach;
}else if(!empty($_GET['teacher_id']) &&  !empty($_GET['day']) && empty($_GET['year']) && empty($_GET['month'])){


$daily_infos=Daily_Info::find_daily_by_day(htmlspecialchars($teacher->id, ENT_QUOTES, 'UTF-8'),htmlspecialchars($_GET['day'], ENT_QUOTES, 'UTF-8'));
foreach($daily_infos as $daily_info): 
?>
...
<?php 
   ...
   $daily_infos=Daily_Info::find_daily_by_year($teacher->id,$_GET['year'], ENT_QUOTES, 'UTF-8');
   foreach($daily_infos as $daily_info):
?>
...
<?php endforeach; 
   ...
   $daily_infos=Daily_Info::find_daily_by_day_month_year($teacher->id,$_GET['day'],$_GET['year'],$_GET['month']);
foreach($daily_infos as $daily_info): 
?>
<tr>
<td><?php echo htmlspecialchars($daily_info->teacher_id, ENT_QUOTES, 'UTF-8'); ?></td>
